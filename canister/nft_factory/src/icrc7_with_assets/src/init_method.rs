...
use crate::{
    assets_stable::{PERMISSION_ADMIN, STATE},
...
pub fn init(arg: InitArg) {
    ...
    STATE.with(|_state| {
        ...
        state.permissions.insert(PERMISSION_ADMIN, ic_cdk::caller());
    });
...
fn pre_upgrade() {
    ...
    crate::assets_stable::pre_upgrade();
}
...
fn post_upgrade() {
    ...
    crate::assets_stable::post_upgrade();
}
